                ...
                <form ref={form} onSubmit={sendEmail}>
                    ...
                    <div className="row py-3">
                        <div className="col-lg-4 col-md-4 m-auto">
                            ...
                            <div className="row py-2 pb-4 d-flex justify-content-center align-items-center">
                                ...
                                <div className=" px-md-2 px-4 col-lg-7 col-md-7 col-sm-7 col-7 d-flex flex-column justify-content-center">
